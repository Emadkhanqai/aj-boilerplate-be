...
#
#   .cs -> dotnet test on the touched project if it is a test project,
...
run_dotnet() {
  ...
  case "${proj##*/}" in
    ...
    *)
      ...
      # The integration suite is deliberately left to /qa — this hook has
