...
One fewer project. Rejected because consumers generate their client types from the shapes in
`Contracts`; keeping them in a project with no dependencies except serialisation makes it
